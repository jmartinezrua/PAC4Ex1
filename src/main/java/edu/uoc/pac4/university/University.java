I have retrieved the content of the file `src/main/java/edu/uoc/pac4/university/University.java`. Now, I will beautify the code and add Javadoc comments to it.

Here is the beautified code with added Javadoc comments:
...
public class University {
     ...
     * @throws UniversityException if the name is null, empty or blank
     */
     ...
     * @throws UniversityException if the abbreviation is null or invalid
     */
     ...
     * @throws UniversityException if the website is null or invalid
     */
...
Next, I can help you commit these changes to the repository. Would you like to proceed with that?
